...
import { EventType } from "@azure/msal-browser/src/event/EventType";
import { InteractionStatus, InteractionType } from "@azure/msal-browser/src/utils/BrowserConstants";
import { PopupRequest, RedirectRequest, SilentRequest, SsoSilentRequest, EndSessionRequest, AuthenticationResult } from "@azure/msal-browser/src";
