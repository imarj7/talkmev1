import Transformation from "@cloudinary/url-gen/backwards/transformation.js";
...
type ExcludedFromTransformation = 'cloud_name' | 'api_key' | 'api_secret' | 'auth_token' | 'cname' | 'secure_distribution' | 'private_cdn' | 'secure' | 'sign_url' | 'long_url_signature' | 'shorten' | 'use_root_path' | 'force_version' | 'ssl_detected' | 'cdn_subdomain' | 'secure_cdn_subdomain' | 'account_id' | 'provisioning_api_key' | 'provisioning_api_secret' | 'version' | 'url_suffix' | 'transformation';
